...
function Home() {
  ...
  return (
    <div className='w-full flex flex-col gap-3'>
      <h1 className='text-center text-xl font-black tracking-widest text-indigo-800'>
        CRUD Productos
      </h1>
      ...
      <form className='flex flex-col gap-3 p-5 rounded bg-indigo-100'>
        ...
        <div className='flex gap-3'>
          <label className='text-indigo-800' htmlFor='input-name'>
            Nombre de producto
          </label>
          <input
        ...
        <div className='flex gap-3'>
          <label className='text-indigo-800' htmlFor='input-price'>
            Precio de producto
          </label>
          <input
            className='border-2 border-indigo-500 rounded px-3'
      ...
      {products.map(item => (
        <div
          className='flex gap-9 p-5 rounded bg-indigo-100 justify-start'
          key={item.id}
        >
          <div>
            <div>
